    ...
    <main className="site">
        ...
        <div className="hero-overlay">
          <div className="welcome-frame">
            ...
            <p>
              ...
              buluşun ister tek başınıza huzurlu bir
              mola verin. Taşkent Cafe, Mardin’de
              lezzet ve samimiyetin buluştuğu özel
      ...
      <div className="waiter-widget">
        ...
        {waiterOpen && (
          <div className="waiter-panel">
            ...
            <div className="waiter-panel-header">
              <div
                className="waiter-avatar-small"
                style={{
                  backgroundImage: `url(${waiterImageUrl})`,
        ...
        >
          ...
          <span
            className="waiter-floating-image"
            style={{
              backgroundImage: `url(${waiterImageUrl})`,
              backgroundSize: "cover",
              backgroundPosition: "center",
          ...
          {!waiterOpen &&
            !waiterMessage && (
              <>
                ...
                <span className="waiter-pulse second" />
              </>
            )}
